...
RetroBuffer.prototype.drawTile = function drawTile(tile, x, y, flipx = false, flipy = false) {
    let
    ...
    this.sspr(drawX, drawY, this.tileset.tileSize.x, this.tileset.tileSize.y, x, y, this.tileset.tileSize.x, this.tileset.tileSize.y, flipx, flipy);
